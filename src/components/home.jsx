    ...
    <div name="Home" className="h-screen w-full  bg-gradient-to-b  from-black via-black to-gray-800 ">
      ...
      ">
        <div className='flex flex-col justify-center h-full'>
          <h2 className="text-2xl text-center mt-[150px] lg:mt-1 lg:text-6xl lg:text-left md:text-6xl md:text-left  font-bold text-white">I am a Front-End Developer</h2>
